...
public final class UiClientNetworking {
    ...
    public static String requestStatusOverview(boolean forceRefresh) {
        return requestStatus(UiAction.STATUS_OVERVIEW, forceRefresh);
    }

    public static String requestStatusRefresh() {
        return requestStatus(UiAction.STATUS_REFRESH, true);
    }

    public static String requestPlayerOverview(boolean forceRefresh) {
        return requestPlayer(UiAction.PLAYER_OVERVIEW, forceRefresh);
    }

    public static String requestPlayerWallet(boolean forceRefresh) {
        return requestPlayer(UiAction.PLAYER_WALLET, forceRefresh);
    }

    public static String requestPlayerActivity(boolean forceRefresh) {
        return requestPlayer(UiAction.PLAYER_ACTIVITY, forceRefresh);
    }

    public static String requestPlayerSummary(boolean forceRefresh) {
        return requestPlayer(UiAction.PLAYER_SUMMARY, forceRefresh);
    }

    public static String requestPlayerRefresh() {
        return requestPlayer(UiAction.PLAYER_REFRESH, true);
    }

    private static String requestStatus(UiAction action, boolean forceRefresh) {
        return send(UiScreenType.STATUS, action, payloadWithForceRefresh(forceRefresh));
    }

    private static String requestPlayer(UiAction action, boolean forceRefresh) {
        return send(UiScreenType.PLAYER, action, payloadWithForceRefresh(forceRefresh));
    }
